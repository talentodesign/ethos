...
//Nome do Site
$core_nome     = "Ethos Psicotestes";
//Descrição do Site
$core_desc     ="A Ethos Psicotestes é uma empresa especializada em produtos para profissionais de psicologia e áreas afins...";
//Palavras-Chaves sobre o site, use virgulas para separa-las
$core_keywords ="ethos,Psicotestes,psicologia,Belém,Pará "; 
//Pasta do projeto
$core_pasta    ="ethos";
