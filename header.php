...
<html lang="pt-br">
  <head>
    ...
    <script>!window.jQuery && document.write('<script src="javascripts/jquery-1.7.js"><\/script>')</script>
      ...
      <link rel="stylesheet" type="text/css" href="<?php servidor(); ?>stylesheets/face.css" media="all">      
      <link rel="stylesheet" type="text/css" href="<?php servidor(); ?>stylesheets/jquery.tweet.css" media="all">
      <link rel="stylesheet" type="text/css" href="<?php servidor(); ?>stylesheets/jquery.jscrollpane.css" media="all">
